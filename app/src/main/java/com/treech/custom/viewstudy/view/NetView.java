    ...
    */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTagCount; i++) {
            ...
            float x = (float) (mCenterX + (mRadius- (fontMetrics.descent + fontMetrics.ascent) / 2) * Math.cos(mAngle * i));
            float y = (float) (mCenterY +(mRadius- (fontMetrics.descent + fontMetrics.ascent) / 2) * Math.sin(mAngle * i));
